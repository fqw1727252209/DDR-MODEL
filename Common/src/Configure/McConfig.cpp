...
namespace dmu{
    ...
    , REFRESH_PENDING_THRESHOLD_FGR(controller_config.RefreshConfig.REFRESH_PENDING_THRESHOLD_FGR)
    ...
    , REFAB_ENABLE(controller_config.RefreshConfig.REFAB_ENABLE)
    , RAA_THRESHOLD(controller_config.RefreshConfig.RAA_THRESHOLD)
    , REF_STAGGER_ENABLE(controller_config.RefreshConfig.REF_STAGGER_ENABLE)
    , MR4_TEMP_MULTIPLIER(controller_config.RefreshConfig.MR4_TEMP_MULTIPLIER)
    , RANK_TREFI_START_VALUES(controller_config.RefreshConfig.RANK_TREFI_START_VALUES)
    , RAAMULT(controller_config.RefreshConfig.RAAMULT)
    , RAADEC(controller_config.RefreshConfig.RAADEC)
    , RAAIMT(controller_config.RefreshConfig.RAAIMT)
    , RAAMMT(controller_config.RefreshConfig.RAAMMT)
    //
