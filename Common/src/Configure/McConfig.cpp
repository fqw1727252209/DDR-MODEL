...
, RD_CNT_THR_EN(controller_config.SchedulerConfig.RD_CNT_THR_EN)
, RD_CNT_THR(controller_config.SchedulerConfig.RD_CNT_THR)
, WR_CNT_THR_EN(controller_config.SchedulerConfig.WR_CNT_THR_EN)
, WR_CNT_THR(controller_config.SchedulerConfig.WR_CNT_THR)
, SW_WR_DELAY_EN(controller_config.SchedulerConfig.SW_WR_DELAY_EN)
, SW_WR_DELAY(controller_config.SchedulerConfig.SW_WR_DELAY)
, PREFER_WR(controller_config.SchedulerConfig.PREFER_WR)
, SW_WR_CAM_THR_EN(controller_config.SchedulerConfig.SW_WR_CAM_THR_EN)
, SW_WR_CAM_THR(controller_config.SchedulerConfig.SW_WR_CAM_THR)
, RD_OPEN_BANK_NUM(controller_config.SchedulerConfig.RD_OPEN_BANK_NUM)
, WR_OPEN_BANK_NUM(controller_config.SchedulerConfig.WR_OPEN_BANK_NUM)
, RD_KEEP_PAGE_NUM(controller_config.SchedulerConfig.RD_KEEP_PAGE_NUM)
, WR_KEEP_PAGE_NUM(controller_config.SchedulerConfig.WR_KEEP_PAGE_NUM)
, PAGE_CLOSE_TIME(controller_config.SchedulerConfig.PAGE_CLOSE_TIME)
...
, REFRESH_MANAGER_ENABLE(controller_config.RefreshConfig.REFRESH_MANAGER_ENABLE)
...
, CBUSY_ENABLE(controller_config.PortConfig.CBUSY_ENABLE)
, MPAM_ENABLE(controller_config.PortConfig.MPAM_ENABLE)
, QOS_MAPPING(controller_config.PortConfig.CalIdMapping.QOS_MAPPING)
, SRC_ID_MAPPING(controller_config.PortConfig.CalIdMapping.SRC_ID_MAPPING)
, QOS_THRESHOD_GROUP0(controller_config.PortConfig.CalIdMapping.QOS_THRESHOD_GROUP0)
, QOS_THRESHOD_GROUP1(controller_config.PortConfig.CalIdMapping.QOS_THRESHOD_GROUP1)
, QOS_THRESHOD_GROUP2(controller_config.PortConfig.CalIdMapping.QOS_THRESHOD_GROUP2)
, SRC_ID_GROUP0(controller_config.PortConfig.CalIdMapping.SRC_ID_GROUP0)
, SRC_ID_GROUP1(controller_config.PortConfig.CalIdMapping.SRC_ID_GROUP1)
, SRC_ID_GROUP2(controller_config.PortConfig.CalIdMapping.SRC_ID_GROUP2)
, PROTQ_FREE_THRESHOLD_LGPR(controller_config.PortConfig.PROTQ_FREE_THRESHOLD_LGPR)
, PROTQ_MIDDLE_THRESHOLD_LGPR(controller_config.PortConfig.PROTQ_MIDDLE_THRESHOLD_LGPR)
, PROTQ_BUSY_THRESHOLD_LGPR(controller_config.PortConfig.PROTQ_BUSY_THRESHOLD_LGPR)
, PROTQ_FREE_THRESHOLD_HPR(controller_config.PortConfig.PROTQ_FREE_THRESHOLD_HPR)
, PROTQ_MIDDLE_THRESHOLD_HPR(controller_config.PortConfig.PROTQ_MIDDLE_THRESHOLD_HPR)
, PROTQ_BUSY_THRESHOLD_HPR(controller_config.PortConfig.PROTQ_BUSY_THRESHOLD_HPR)
, PROTQ_FREE_THRESHOLD_WR(controller_config.PortConfig.PROTQ_FREE_THRESHOLD_WR)
, PROTQ_MIDDLE_THRESHOLD_WR(controller_config.PortConfig.PROTQ_MIDDLE_THRESHOLD_WR)
, PROTQ_BUSY_THRESHOLD_WR(controller_config.PortConfig.PROTQ_BUSY_THRESHOLD_WR)
, PROTQ_FREE_THRESHOLD_RD(controller_config.PortConfig.PROTQ_FREE_THRESHOLD_RD)
, PROTQ_MIDDLE_THRESHOLD_RD(controller_config.PortConfig.PROTQ_MIDDLE_THRESHOLD_RD)
, PROTQ_BUSY_THRESHOLD_RD(controller_config.PortConfig.PROTQ_BUSY_THRESHOLD_RD)
, CAM_FREE_THRESHOLD_LGPR(controller_config.PortConfig.CAM_FREE_THRESHOLD_LGPR)
, CAM_MIDDLE_THRESHOLD_LGPR(controller_config.PortConfig.CAM_MIDDLE_THRESHOLD_LGPR)
, CAM_BUSY_THRESHOLD_LGPR(controller_config.PortConfig.CAM_BUSY_THRESHOLD_LGPR)
, CAM_FREE_THRESHOLD_HPR(controller_config.PortConfig.CAM_FREE_THRESHOLD_HPR)
, CAM_MIDDLE_THRESHOLD_HPR(controller_config.PortConfig.CAM_MIDDLE_THRESHOLD_HPR)
, CAM_BUSY_THRESHOLD_HPR(controller_config.PortConfig.CAM_BUSY_THRESHOLD_HPR)
, CAM_FREE_THRESHOLD_WR(controller_config.PortConfig.CAM_FREE_THRESHOLD_WR)
, CAM_MIDDLE_THRESHOLD_WR(controller_config.PortConfig.CAM_MIDDLE_THRESHOLD_WR)
, CAM_BUSY_THRESHOLD_WR(controller_config.PortConfig.CAM_BUSY_THRESHOLD_WR)
, CAM_BASED(controller_config.PortConfig.CAM_BASED)
, PROTQ_BASED(controller_config.PortConfig.PROTQ_BASED)
