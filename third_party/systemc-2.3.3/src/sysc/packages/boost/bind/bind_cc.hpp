...
template<class R>
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (), _bi::list0>
...
template<class R, class B1, class A1>
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1), typename _bi::list_av_1<A1>::type>
...
template<class R, class B1, class B2, class A1, class A2>
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2), typename _bi::list_av_2<A1, A2>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3), typename _bi::list_av_3<A1, A2, A3>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4), typename _bi::list_av_4<A1, A2, A3, A4>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4, B5), typename _bi::list_av_5<A1, A2, A3, A4, A5>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4, B5, B6), typename _bi::list_av_6<A1, A2, A3, A4, A5, A6>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4, B5, B6, B7), typename _bi::list_av_7<A1, A2, A3, A4, A5, A6, A7>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4, B5, B6, B7, B8), typename _bi::list_av_8<A1, A2, A3, A4, A5, A6, A7, A8>::type>
...
template<class R,
    ...
    _bi::bind_t<R, SC_BOOST_BIND_ST R (SC_BOOST_BIND_CC *) (B1, B2, B3, B4, B5, B6, B7, B8, B9), typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type>
